    ...
    <section className="relative border-t border-border/50 bg-background py-16">
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="mb-12 flex items-center justify-between border-b border-border pb-4">
          <h2 className="font-sans-tech text-3xl font-bold tracking-tight text-foreground">
            // PLATFORM_METRICS
          </h2>
        ...
        <div className="mb-16 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat, index) => (
            <Card
              key={index}
              className="group border border-border bg-card/20 p-6 backdrop-blur-sm transition-all duration-300 hover:border-primary/50"
            >
