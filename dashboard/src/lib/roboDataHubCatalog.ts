    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          {
            title: "Blade Server Hot-Swap",
            description: "Blade extraction, swap, and reseat workflows with operator-safe handling steps.",
            tags: ["EXO-Centric", "Task Labels"],
            availability: "On-demand",
            hours: "520 hrs",
          ...
          {
            title: "Power Distribution Unit Check",
            description: "Power and fault-state inspection routines across distribution hardware and rack-side controls.",
      ...
      },
      {
        ...
        cards: [
          ...
          {
            title: "Drive Bay Diagnostics",
            description: "Drive-bay inspection and diagnostics with error-state review and replacement prep.",
            tags: ["EGO-Centric", "Defect Labels"],
            availability: "In Library",
            hours: "440 hrs",
          ...
          },
          {
            ...
            description: "Card insert and verification steps for rack-side network module maintenance.",
            tags: ["EXO-Centric", "Task Labels"],
            availability: "On-demand",
            hours: "310 hrs",
  ...
  dexterity: {
    ...
    sections: [
      ...
      },
      {
        ...
        countLabel: "3 datasets",
        cards: [
          ROOT_SHOWCASE_SECTIONS[2].cards[1],
          {
            title: "Floor Mopping & Sweeping",
            description: "Floor-care routines with long-arm sweeps, obstacle avoidance, and pattern consistency.",
            tags: ["EGO-Centric", "Hand Pose", "Edge Cases"],
            availability: "On-demand",
            hours: "410 hrs",
          ...
          },
          {
            ...
            images: imageSet("humanoid/humanoid3.png", "humanoid/humanoid4.png", "humanoid/humanoid1.png", "humanoid/humanoid5.png"),
          },
        ],
      },
      {
        ...
        countLabel: "3 datasets",
        cards: [
          ROOT_SHOWCASE_SECTIONS[2].cards[2],
          ROOT_SHOWCASE_SECTIONS[2].cards[3],
          {
            title: "Object Organization",
            description: "Structured hand-object placement and retrieval patterns for service and home routines.",
            tags: ["EXO-Centric", "Task Labels"],
            availability: "In Library",
            hours: "340 hrs",
    ...
    sections: [
      {
        ...
        cards: [
          ...
          {
            title: "Bin Picking - Unstructured Piles",
            description: "Picking from dense, mixed piles with clutter and varying SKU geometry.",
            tags: ["EXO-Centric", "Task Labels", "Bbox"],
            availability: "On-demand",
            hours: "760 hrs",
          ...
          {
            title: "Multi-Shape SKU Grasping",
            description: "Object-specific grasp strategies across mixed packages, soft goods, and rigid inventory.",
            tags: ["EGO-Centric", "Task Labels", "Edge Cases"],
            availability: "In Library",
            hours: "540 hrs",
      ...
      },
      {
        ...
        countLabel: "3 datasets",
        cards: [
          ROOT_SHOWCASE_SECTIONS[1].cards[1],
          {
            title: "Conveyor Loading & Sortation",
            description: "Inbound-to-conveyor handoff workflows with sequencing around loading and diversion.",
            tags: ["EXO-Centric", "Task Labels", "Seg"],
            availability: "On-demand",
            hours: "780 hrs",
    ...
    sections: [
      {
        ...
        cards: [
          ...
          ROOT_SHOWCASE_SECTIONS[3].cards[1],
          {
            ...
            description: "Glass placement, seal alignment, and final verification across multiple body styles.",
            tags: ["EXO-Centric", "Task Labels", "Bbox"],
            availability: "On-demand",
            hours: "880 hrs",
          ...
          {
            title: "Door Panel Trim Fitting",
            description: "Clip insertion, alignment, and trim quality checks across passenger cabin workflows.",
            tags: ["EXO-Centric", "Task Labels"],
            availability: "In Library",
            hours: "760 hrs",
          ...
          },
          {
            ...
            images: imageSet("carAutomation/carAutomation4.png", "carAutomation/carAutomation5.png", "carAutomation/carAutomation3.png", "carAutomation/carAutomation2.png"),
          },
          {
      ...
      },
      {
        ...
        cards: [
          ...
          {
            title: "Grille & Fascia Gap Inspection",
            description: "Perimeter gap checks and fascia alignment inspection around front-end assemblies.",
            tags: ["EGO-Centric", "Task Labels"],
            availability: "In Library",
            hours: "610 hrs",
          ...
          {
            title: "Torque Verification Scan",
            description: "Final-stage verification sequences checking fastener completion and torque sign-off.",
            tags: ["EXO-Centric", "Task Labels"],
            availability: "In Library",
            hours: "520 hrs",
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            images: imageSet("carAutomation/carAutomation5.png", "carAutomation/carAutomation4.png", "carAutomation/carAutomation3.png", "carAutomation/carAutomation2.png"),
          },
          {
          ...
          },
          {
            ...
            images: imageSet("carAutomation/carAutomation2.png", "carAutomation/carAutomation3.png", "carAutomation/carAutomation5.png", "carAutomation/carAutomation4.png"),
          },
        ],
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            images: imageSet("carAutomation/carAutomation4.png", "carAutomation/carAutomation2.png", "carAutomation/carAutomation3.png", "carAutomation/carAutomation5.png"),
          },
          {
