  ...
  return (
    <div className="flex justify-center xl:hidden">
      <div className="rounded-[14px] border border-violet-200 bg-card px-5 py-4 text-center shadow-[0_10px_25px_rgba(124,58,237,0.08)] dark:border-slate-700">
        ...
        <p className="w-full whitespace-nowrap text-center text-[10px] font-black uppercase leading-tight tracking-[0.03em] text-violet-700 dark:text-violet-200">RoboHandMotion</p>
  ...
  return (
    <>
      ...
      <div className="hidden h-full items-center justify-center xl:flex">
        <div className="mx-1 flex w-[126px] flex-col items-center">
          ...
          <div className="w-full rounded-[16px] border-[1.5px] border-violet-300 bg-card px-3 py-4 text-center shadow-[0_12px_28px_rgba(124,58,237,0.08)] dark:border-violet-800/60">
            ...
            <p className="w-full whitespace-nowrap text-center text-[9px] font-black uppercase leading-tight tracking-[0.02em] text-violet-700 dark:text-violet-200">RoboHandMotion</p>
...
export default function RoboHandMotion() {
  ...
  const showcaseItems: FeatureShowcaseItem[] = [
    ...
    {
      id: "hand-motion-capture",
      label: "21-Keypoint MoCap",
      shortLabel: "MoCap",
      accent: "orange",
      content: (
        <div className="rounded-[18px] border border-slate-200 bg-card p-6 shadow-[0_1px_4px_rgba(0,0,0,0.04)] dark:border-slate-700">
    ...
    },
    {
      ...
      content: (
        <div className="rounded-[18px] border border-slate-200 bg-card p-6 shadow-[0_1px_4px_rgba(0,0,0,0.04)] dark:border-slate-700">
          ...
          <div className="mt-6 grid gap-4 xl:grid-cols-[minmax(0,0.9fr)_126px_minmax(0,1.1fr)] xl:items-center">
            <div>
          ...
          <div className="mx-auto max-w-[1280px]">
            ...
            <section className="flex flex-col gap-10">
              <FeatureShowcaseCarousel
                ariaLabel="RoboHandMotion showcase"
                initialItemId="hand-motion-capture"
                items={showcaseItems}
              />
                ...
                <div className="mt-1 flex flex-col justify-between gap-6 rounded-[14px] border-[1.5px] border-dashed border-violet-300 bg-gradient-to-br from-violet-50 to-orange-50 px-8 py-7 lg:flex-row lg:items-center dark:border-violet-900/50 dark:from-violet-950/20 dark:to-orange-950/20">
                  <div className="flex items-center gap-4">
                    <div>
                      ...
                      <p className="max-w-[500px] text-[12px] leading-5 text-slate-500 dark:text-slate-400">
                        Upload your hand-task footage into RoboDataHub, then open the dataset to run tracking, 21-keypoint MoCap, or mesh generation when you&apos;re ready.
                      </p>
                    </div>
                  </div>
