  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background font-sans-tech text-foreground">
      ...
      <main className="relative z-10 flex min-h-0 flex-1 flex-col pt-16">
        <header className="border-b border-border bg-card/30 px-4 py-6 backdrop-blur-sm md:px-8">
        ...
        <div className="mx-auto flex min-h-0 w-full max-w-7xl flex-1 flex-col md:flex-row">
          <aside className="custom-scrollbar w-full shrink-0 overflow-y-auto border-b border-border bg-card/20 md:w-[min(100%,280px)] md:border-b-0 md:border-r lg:w-1/4">
